  ...
  <section class="section">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <form class="" action="<?php echo base_url('admin/data_mobil/update_mobil_aksi') ?>" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label>Denda</label>
                <input type="text" name="tahun" class="form-control" value="<?php echo $mb->denda; ?>">
